...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img src="/img/ARS3.png" width="130" height="35" class="d-inline-block align-top" alt="">
                </a>
    ...
    <footer class="py-4 bg-dark">
        <div class="container">
            ...
            <p class="m-0 text-center text-light">Email: <a
                    href="mailto:1931710038@student.polinema.ac.id">1931710038@student.polinema.ac.id</a></p>
        </div>
    </footer>
    <!-- JavaScript files-->
