  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="post col-md-4">
        <div class="item"><a href="{{'storage/'.$culture->featured_image}}" data-fancybox="gallery" class="image"><img src="{{'storage/'.$culture->featured_image}}" alt="..." class="img-fluid">
            <div class="overlay d-flex align-items-center justify-content-center"></div>
          </a></div>
        <div class="post-details">
          <div class="post-meta d-flex justify-content-between">
            <div class="date">{{$culture->getUpdatedAtAtribute()}}</div>
            <div class="category"><strong>{{$culture-> category}}</strong></div>
          </div>
        </div>
      </div>
      @endforeach
