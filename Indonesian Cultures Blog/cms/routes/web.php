...
Route::get('/post/deleteComment/{id}', 'PostController@deleteComment'); // Menghapus Data (Delete Data)
Route::post('/post/updateComment/{id}', 'PostController@updateComment'); // Menghapus Data (Delete Data)
...
Route::get('/user/cetak_pdf', 'ManageUsersController@cetak_pdf');
/*-------------*/
