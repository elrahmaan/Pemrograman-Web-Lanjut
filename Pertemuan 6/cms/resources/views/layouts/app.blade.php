        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img src="https://cmxpv89733.i.lithium.com/t5/image/serverpage/image-id/3032iB0DBA4C2FDFC60E1/image-size/large?v=1.0&px=999" width="120" height="33" class="d-inline-block align-top" alt="">
                </a>
