    ...
    <h2>Tambah Data Artikel</h2>
        <form action="/article/create" method="post">
            ...
            <div class="form-group">
                ...
                <!-- <input type="text" class="form-control" required="required" name="intro"></br> -->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required="required" name="featured_image"></br>
            </div>
            <div class="form-group">
                <label for="paragraph1">Paragraph 1</label>
                <textarea class="form-control" required="required" name="paragraph1"></textarea><br>
                <!-- <input type="text" class="form-control" required="required" name="paragraph1"></br> -->
            </div>
            <div class="form-group">
                <label for="paragraph2">Paragraph 2</label>
                <!-- <input type="text" class="form-control" required="required" name="paragraph2"></br> -->
